...
class MainWindow(QMainWindow):
    ...
    def on_stackedWidget_currentChanged(self, index):
        btn_list = self.ui.icon_widget.findChildren(QPushButton) \
                   + self.ui.menu_widget.findChildren(QPushButton)
    ...
    def on_dashboards_btn_1_toggled(self):
        self.ui.stackedWidget.setCurrentIndex(1)

    def on_dashboards_btn_2_toggled(self):
        self.ui.stackedWidget.setCurrentIndex(1)
    ...
    def on_customer_btn_1_toggled(self):
        self.ui.stackedWidget.setCurrentIndex(4)

    def on_customer_btn_2_toggled(self):
        self.ui.stackedWidget.setCurrentIndex(4)
